...
CONFIG_PATH="config/ner/config_ner_medprocner.yaml"
python run_ner_pipeline.py --config_path "$CONFIG_PATH" --force_fine_tuning --force_tokenize --model="eriberta" --seed=442
python delete_checkpoints.py --config_path "$CONFIG_PATH" --model="eriberta"

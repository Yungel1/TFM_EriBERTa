...
NER_TYPE_SEPARATOR = "$"
NER_ENTITY_LIST = ['O', "CALLE", "CENTRO_SALUD", "CORREO_ELECTRONICO", "EDAD_SUJETO_ASISTENCIA",
                   "FAMILIARES_SUJETO_ASISTENCIA", "FECHAS", "HOSPITAL", "ID_ASEGURAMIENTO",
                   "ID_CONTACTO_ASISTENCIAL", "ID_SUJETO_ASISTENCIA", "ID_TITULACION_PERSONAL_SANITARIO",
                   "INSTITUCION", "NOMBRE_PERSONAL_SANITARIO", "NOMBRE_SUJETO_ASISTENCIA", "NUMERO_FAX",
                   "NUMERO_TELEFONO", "OTROS_SUJETO_ASISTENCIA", "PAIS", "PROFESION",
                   "SEXO_SUJETO_ASISTENCIA", "TERRITORIO"
                   ]
